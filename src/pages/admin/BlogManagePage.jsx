              ...
              >
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg cursor-pointer transition-colors duration-150 hover:bg-[var(--color-surface-overlay)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] disabled:opacity-50"
                  ...
                  <Link
                    ...
                    className="p-2 rounded-lg cursor-pointer transition-colors duration-150 hover:bg-[var(--color-surface-overlay)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)]"
