...
function ToolbarBtn({ onClick, active, disabled, title, children }) {
  return (
    <button
      ...
      aria-label={title}
      aria-pressed={active}
      className="w-8 h-8 flex items-center justify-center rounded-md text-sm font-medium transition-all duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] disabled:opacity-40"
      style={
        active
